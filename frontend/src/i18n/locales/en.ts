export default {
  ...
  printers: {
    ...
    toast: {
      ...
      failedToSetBedTemp: 'Failed to set bed temperature',
      failedToSetNozzleTemp: 'Failed to set nozzle temperature',
      failedToSetChamberTemp: 'Failed to set chamber temperature',
      failedToSetFanSpeed: 'Failed to set fan speed',
  ...
  locations: {
    ...
    moveSuccess: 'Spool moved',
    moveFailed: 'Failed to move spool',
    moveInvalid: 'Invalid storage location',
    history: 'Location history',
    historyEmpty: 'No location changes recorded yet',
