export default {
  ...
  printers: {
    ...
    toast: {
      ...
      failedToSetBedTemp: 'Échec du réglage de la température du plateau',
      failedToSetNozzleTemp: 'Échec du réglage de la température de la buse',
      failedToSetChamberTemp: 'Échec du réglage de la température de la chambre',
      failedToSetFanSpeed: 'Échec du réglage de la vitesse du ventilateur',
    ...
    temperatureControl: {
      adjust: 'Définir la température cible',
      target: 'Cible',
      current: 'Actuelle : {{temp}}°C',
      apply: 'Appliquer',
      off: 'Arrêt',
      turnOff: 'Éteindre le chauffage',
    },
    fanControl: {
      adjust: 'Définir la vitesse du ventilateur',
      speed: 'Vitesse',
      apply: 'Appliquer',
    },
    // HMS errors
