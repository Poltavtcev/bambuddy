export default {
  ...
  printers: {
    ...
    toast: {
      ...
      failedToSetBedTemp: 'ベッド温度の設定に失敗しました',
      failedToSetNozzleTemp: 'ノズル温度の設定に失敗しました',
      failedToSetChamberTemp: 'チャンバー温度の設定に失敗しました',
      failedToSetFanSpeed: 'ファン速度の設定に失敗しました',
