export default {
  ...
  printers: {
    ...
    toast: {
      ...
      failedToSetBedTemp: 'Falha ao definir a temperatura da mesa',
      failedToSetNozzleTemp: 'Falha ao definir a temperatura do bico',
      failedToSetChamberTemp: 'Falha ao definir a temperatura da câmara',
      failedToSetFanSpeed: 'Falha ao definir a velocidade do ventilador',
    ...
    temperatureControl: {
      adjust: 'Definir temperatura alvo',
      target: 'Alvo',
      current: 'Atual: {{temp}}°C',
      apply: 'Aplicar',
      off: 'Desligado',
      turnOff: 'Desligar aquecedor',
    },
    fanControl: {
      adjust: 'Definir velocidade do ventilador',
      speed: 'Velocidade',
      apply: 'Aplicar',
    },
    // HMS errors
