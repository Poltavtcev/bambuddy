...
// Ukrainian: brand names, URLs, placeholders, and international technical terms
// that legitimately match en.ts (same approach as DE/FR cognate lists).
const UK_COGNATES = [
  "(25%, 50%, 75%)",
  "(Spoolman)",
  "({{count}}/8)",
  ...
  "https://forgejo.example.com/username/repo-name",
  "https://gitea.example.com/username/repo-name",
